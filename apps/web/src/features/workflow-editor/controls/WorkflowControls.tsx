...
export const WorkflowControls: React.FC<WorkflowControlsProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <button 
        className="inline-flex items-center justify-center size-[28px] rounded-md text-[var(--text-muted)] hover:text-white hover:bg-[var(--surface-hover)] transition-all disabled:opacity-30"
        title="Undo"
      >
