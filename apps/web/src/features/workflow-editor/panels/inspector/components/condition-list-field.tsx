...
export const ConditionListField: React.FC<ConditionListFieldProps> = ({
  value = [],
  onChange,
  onShowPicker,
  isFirstClickAllowed,
            ...
            <div className="w-full bg-transparent overflow-hidden">
              <Editor
                ...
                onFocus={(e: any) => {
                  ...
                  const subId = `cond-${index}`
                  if (isFirstClickAllowed && onShowPicker && onFirstClickUsed && isFirstClickAllowed(subId)) {
                    ...
                    onShowPicker(rect, (val) => {
                      ...
                      updateExpression(index, newVal)
                    })
                    onFirstClickUsed(subId)
                  }
                }}
                onClick={(e: any) => {
                  const target = e.target as HTMLTextAreaElement
