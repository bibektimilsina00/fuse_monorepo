...
class SlackClient:
    ...
    async def post(self, path: str, json: dict | None = None, data: dict | None = None, files: dict | None = None) -> dict[str, Any]:
        ...
        if self._external_client:
            ...
            response = await self._external_client.post(url, json=json, data=data, files=files, headers=headers)
        else:
            ...
            response = await self._client.post(path, json=json, data=data, files=files, headers=headers)
