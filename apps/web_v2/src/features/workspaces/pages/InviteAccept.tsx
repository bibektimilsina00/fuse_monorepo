    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] p-6">
        <div className="w-full max-w-[420px] bg-[var(--bg-2)] border border-[var(--border-faint)] rounded-[20px] pt-[36px] px-[32px] pb-[32px] flex flex-col items-center gap-[14px] shadow-[0_24px_56px_-20px_oklch(0_0_0/0.5)] text-center">
          ...
          <p className="text-[13px] text-[var(--text-faint)] m-0">
            Loading invite…
          </p>
        </div>
      </div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] p-6">
        <div className="w-full max-w-[420px] bg-[var(--bg-2)] border border-[var(--border-faint)] rounded-[20px] pt-[36px] px-[32px] pb-[32px] flex flex-col items-center gap-[14px] shadow-[0_24px_56px_-20px_oklch(0_0_0/0.5)] text-center">
          ...
          <p className="text-[14px] text-[var(--text-mute)] m-0 flex items-center justify-center gap-[8px]">
            This invite link is no longer valid. Ask the workspace admin to send
            a new one.
          </p>
          <button
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] p-6">
      <div className="w-full max-w-[420px] bg-[var(--bg-2)] border border-[var(--border-faint)] rounded-[20px] pt-[36px] px-[32px] pb-[32px] flex flex-col items-center gap-[14px] shadow-[0_24px_56px_-20px_oklch(0_0_0/0.5)] text-center">
        ...
        <p className="text-[14px] text-[var(--text-mute)] m-0 flex items-center justify-center gap-[8px]">
          ...
          <span
            className={cn(
              ...
              preview.role === "owner" &&
                "bg-[oklch(0.78_0.14_145/0.14)] text-[var(--ok)]",
              preview.role === "admin" &&
                "bg-[oklch(0.78_0.13_245/0.14)] text-[var(--accent)]",
              preview.role === "member" &&
        ...
        <p className="text-[12.5px] text-[var(--text-faint)] m-0">
          Invite sent to{" "}
          <strong className="text-[var(--text-mute)]">{preview.email}</strong>
        </p>
        ...
        {alreadyAccepted ? (
          ...
          <>
            ...
            {accept.isError && (
              <p className="text-[12.5px] text-[var(--err)] m-0">
