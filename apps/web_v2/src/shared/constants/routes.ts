...
export const APP_ROUTES = {
  ...
  KNOWLEDGE_DOCUMENT: (kbId: string, docId: string) =>
    `/knowledge/${kbId}/documents/${docId}`,
  KB_CHUNKS: (kbId: string, docId: string) =>
    `/kb/${kbId}/documents/${docId}/chunks`,
...
export const API_ROUTES = {
  ...
  CREDENTIAL_OAUTH_URL: (service: string) =>
    `/credentials/oauth/${service}/url`,
  ...
  KB_DOC_REINDEX: (kbId: string, docId: string) =>
  ...
  TABLE_COLUMN: (tableId: string, columnId: string) =>
    `/tables/${tableId}/columns/${columnId}`,
  TABLE_ROWS: (id: string) => `/tables/${id}/rows`,
  TABLE_ROW: (tableId: string, rowId: string) =>
